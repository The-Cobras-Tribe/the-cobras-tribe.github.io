...
function Quote() {
  ...
  return (
    <>
      <section class='bg-white dark:bg-stone-900/80 backdrop-filter backdrop-blur-sm'>
        <div class='max-w-screen-xl px-4 py-8 mx-auto text-center lg:py-16 lg:px-6'>
          ...
          <figure class='max-w-screen-md mx-auto'>
            <svg
              class='h-12 mx-auto mb-3 text-green-200'
              viewBox='0 0 24 27'
              fill='none'
            ...
            <blockquote>
              <p class='text-2xl font-medium text-green-400'>{`"${quote}"`}</p>
            </blockquote>
          </figure>
        </div>
      </section>
